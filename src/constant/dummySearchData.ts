...
export const SEARCH_ITEM_ICONS = {
  readingRoom: { icon: BookIcon, iconWidth: 14, iconHeight: 16 },
  classroom: { icon: ClassroomIcon, iconWidth: 18, iconHeight: 20 },
  building: { icon: BuildingIcon, iconWidth: 15, iconHeight: 16 },
  restaurant: { icon: RestaurantIcon, iconWidth: 13, iconHeight: 16 },
  cafe: { icon: CafeIcon, iconWidth: 16, iconHeight: 15 },
  store: { icon: StoreIcon, iconWidth: 16, iconHeight: 15 },
  pcRoom: { icon: PcIcon, iconWidth: 16, iconHeight: 16 },
  printer: { icon: PrinterIcon, iconWidth: 16, iconHeight: 14 },
  bookReturn: { icon: BookReturnIcon, iconWidth: 14, iconHeight: 16 },
  smokingArea: { icon: SmokeIcon, iconWidth: 16, iconHeight: 15 },
...
export const DUMMY_RECENT_SEARCHES: RecentSearchItem[] = [
  { id: 'r1', building: 'H동', place: '중앙도서관', room: '314호', category: 'readingRoom', date: '04.10' },
  ...
  { id: 'r6', building: 'S동', place: '학생회관', room: '편의점', category: 'store', date: '04.07' },
